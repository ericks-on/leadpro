...
export default function SalessForm() {
    ...
    return (
        <main className="container mx-auto">
            <h1 className="text-2xl text-center font-semibold text-gray-800 ">Add Sale</h1>
            <form className="mt-6" action={formAction}>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:h-20 md:w-3/4 md:mx-auto">
                    <div>
                        <label className="text-gray-700" htmlFor="quantity">Type of Sale</label>
                        <input className="w-full px-4 py-2 mt-2 border rounded-lg" type="text" id="type" name="type" />
                    </div>
                    <div>
                        <label className="text-gray-700" htmlFor="price">Quantity</label>
